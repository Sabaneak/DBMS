...
class Prisoner_Login(Resource):
    def post(self):
        ...
        if res == "[]":
            ...
            return {'access_token': access_token, 'User {}'.format(body['pid']): res}, 200
...
class Official_Login(Resource):
    def post(self):
        ...
        if res == "[]":
            ...
            return {'access_token': access_token, 'User {}'.format(body['empid']): res}, 200
...
class Business_Login(Resource):
    def post(self):
        ...
        if res == "[]":
            ...
            return {'access_token': access_token, 'User {}'.format(body['bid']): res}, 200
...
class Relative_Login(Resource):
    def post(self):
        ...
        if res == "[]":
            ...
            return {'access_token': access_token, 'User {}'.format(body['rid']): res}, 200
